function [data_all_mice, miceIDs] = load_multi_session_swr(varargin)
...
% Load data
if strcmp(varargin{1,1}, 'in')
    data_str = '_multi_day_SWR_inhibitoryCells.mat';
elseif strcmp(varargin{1,1}, 'pc')
    data_str = '_multi_day_SWR_principalCells.mat';
end
