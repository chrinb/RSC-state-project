...
% s1 = scatter(x_vec1, data_pre_RF, 'filled', 'MarkerFaceColor','r');
% s2 = scatter(x_vec2, data_post_RF, 'filled', 'MarkerFaceColor','b');
if ~iscell(data(1,:))
    for i = 1:n_mice
    ...
    % plot( [jitter_factor1; jitter_factor2], [data_pre_RF; data_post_RF], 'Color',[.5 .5 .5])
end
s1.MarkerFaceAlpha = .2;
s2.MarkerFaceAlpha = .2;
...
% s1 = scatter(x_vec1, data_pre_GOL, 'filled', 'MarkerFaceColor','r');
% s2 = scatter(x_vec2, data_post_GOL, 'filled', 'MarkerFaceColor','b');
...
if ~iscell(data(1,:))
    ...
    % plot([jitter_factor1; jitter_factor2], [data_pre_GOL; data_post_GOL], 'Color',[.5 .5 .5])
end
s1.MarkerFaceAlpha = .2;
s2.MarkerFaceAlpha = .2;
